    ...
    while (client.connected() && currentTime - previousTime <= timeoutTime) { // loop while the client's connected
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          client.println("<td> " + output4State + "</td>");
          client.println("</tr>");
          //----------------- first row closing -----------------          
         ...
         //----------------- third row opening -----------------
          ...
          if (output6State=="off") {
              client.println(" <td><a href=\"/6/on\"><button class=\"button\">ON</button></a></td>");    
           } else {
              client.println("<td><a href=\"/6/off\"><button class=\"button button2\">OFF</button></a></td>");
            }                    
          ...
          if (output7State=="off") {
              client.println(" <td><a href=\"/7/on\"><button class=\"button\">ON</button></a></td>");    
           } else {
              client.println("<td><a href=\"/7/off\"><button class=\"button button2\">OFF</button></a></td>");
            }                    
          // Display current state, and ON/OFF buttons for GPIO 6  
